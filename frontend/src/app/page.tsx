    ...
    <div className="min-h-screen bg-gradient-to-b from-primary-50 to-background">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-12">
          ...
          <div className="flex flex-col space-y-6 md:w-1/2">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              <Link 
                href="/auth?tab=login" 
                className="inline-flex items-center justify-center h-10 px-6 py-2 bg-primary text-primary-foreground font-medium rounded-md shadow-sm hover:bg-primary/90 transition-colors text-center"
              >
                立即登入 (Alpha 測試版)
              </Link>
              <Link 
      ...
      <div className="container mx-auto px-4 py-16 bg-background">
        ...
        <div className="grid md:grid-cols-3 gap-10">
          {/* Feature 1 */}
          <div className="flex flex-col items-center text-center p-6 rounded-xl bg-background hover:bg-muted/30 transition-colors">
      ...
      <div className="container mx-auto px-4 py-16 text-center">
        <div className="max-w-3xl mx-auto bg-muted p-8 md:p-12 rounded-lg shadow-md">
